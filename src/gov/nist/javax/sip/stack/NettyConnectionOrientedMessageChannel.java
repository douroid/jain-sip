 ...
 *
 */
public abstract class NettyConnectionOrientedMessageChannel extends MessageChannel implements
    ...
    public NettyConnectionOrientedMessageChannel(SIPTransactionStack sipStack) {
     ...
     *
     * Jvb: note that this code is identical to TCPMessageChannel, refactor some
     * day
     */
    @Override
    public void processMessage(SIPMessage sipMessage) throws Exception {
        try {
            ...
            if (sipMessage instanceof SIPRequest) {
                ...
                Hop hop = sipStack.addressResolver.resolveAddress(viaHop);
                ...
                try {
                    ...
                    if (v.getParameter(Via.RPORT) != null
                            || !hop.getHost().equals(
                ...
                if (!this.isCached && mySock != null) { // self routing makes
                    ...
                    ((NettyConnectionOrientedMessageProcessor) this.messageProcessor).cacheMessageChannel(this);
                }
            }
    ...
    public void run() {
        ...
        try {
            ...
            ((NettyConnectionOrientedMessageProcessor) this.messageProcessor).useCount--;
...
//        long delay = newScheduledTime > now ? newScheduledTime - now : 1;
    ...
    public void channelRead0(ChannelHandlerContext chc, SipMessageEvent i) throws Exception {
        ...
        if (i.getMessage() instanceof SipRequest) {
            this.processMessage(new SIPRequestImpl((SipRequest) i.getMessage()));
        } else {
            this.processMessage(new SIPResponseImpl((SipResponse) i.getMessage()));
        }
    }
}
