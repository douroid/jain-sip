...
public class SIPResponseImpl
    ...
    public int getStatusCode() {
        SipResponseLine respLine = msgImpl.getResponseLine();
        return respLine.getStatusCode();
    }
    ...
    /** Constructor.
     */
    public SIPResponseImpl() {
        super();
    }
    
    /** Constructor.
     */
    public SIPResponseImpl(SipResponse response) {
        super(response);
    }    
    /**
    ...
    public String debugDump() {
        ...
        sprint(SIPResponseImpl.class.getCanonicalName());
        sprint("{");
        if (statusLine != null) {
    ...
    public void checkHeaders() throws ParseException {
        ...
        if (getViaHeaders() == null) {
            throw new ParseException(ViaHeader.NAME+ " Is missing ", 0);
        }
        if (getCallId() == null) {
    ...
    */
    ...
    public Object clone() {
        SIPResponseImpl retval = (SIPResponseImpl) super.clone();
        if (this.statusLine != null)
    ...
    public boolean equals(Object other) {
        if (!this.getClass().equals(other.getClass()))
            return false;
        SIPResponseImpl that = (SIPResponseImpl) other;
    ...
    public boolean match(Object matchObj) {
        if (matchObj == null)
            ...
            return true;
        SIPResponseImpl that = (SIPResponseImpl) matchObj;
    ...
    public String toString() {
        ...
        //TODO else return statusLine.encode() + super.encode();
        return "";
    }
